...
class Instruction(object):
    ...
    def encode(self) -> int:
        ...
        my_bitstring = instr_field.insert(self.op.value, 0)
        my_bitstring = cond_field.insert(self.cond.value, my_bitstring)
        my_bitstring = reg_target_field.insert(self.reg_target, my_bitstring)
        my_bitstring = reg_src1_field.insert(self.reg_src1, my_bitstring)
        my_bitstring = reg_src2_field.insert(self.reg_src2, my_bitstring)
        my_bitstring = offset_field.insert(self.offset, my_bitstring)
        return my_bitstring
